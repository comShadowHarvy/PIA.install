...
# --- User Configuration ---
PIA_USERNAME="username"        # Your Private Internet Access Username; update with your actual username.
PIA_PASSWORD="password"        # Your Private Internet Access Password; update with your actual password.
DEFAULT_PIA_CONFIG_FILE="ca_ontario.ovpn" # Default PIA .ovpn config to use (e.g., ca_ontario.ovpn); change to a different server config if desired.
